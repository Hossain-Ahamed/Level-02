...
const getSingleOfferedCourse = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await OfferedCourseServices.getSingleOfferedCoursesFromDB(req.params?.id);
	sendResponse(res, {
		statusCode: httpStatus.OK,
		success: true,
		message: "Offered Course retrieved Successfully",
...
const deleteOfferedCourse = catchAsync(async (req: Request, res: Response) => {
	...
	const result = await OfferedCourseServices.DeleteOfferedCoursesFromDB(req.params?.id);
	sendResponse(res, {
		statusCode: httpStatus.OK,
		success: true,
